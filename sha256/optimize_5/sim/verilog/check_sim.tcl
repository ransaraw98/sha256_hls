...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sha256.autotvin_stateREG.dat"
         "c.sha256.autotvin_data.dat"
         "c.sha256.autotvin_hash.dat"
         "c.sha256.autotvout_stateREG.dat"
         "c.sha256.autotvout_hash.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sha256.autotvout_stateREG.dat"
         "rtl.sha256.autotvout_hash.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
