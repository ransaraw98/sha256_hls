...
architecture rtl of sha256_k_rom is 
...
architecture arch of sha256_k is
    component sha256_k_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sha256_k_rom_U :  component sha256_k_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
