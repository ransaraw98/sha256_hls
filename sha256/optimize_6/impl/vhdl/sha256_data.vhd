...
architecture rtl of sha256_data_ram is 
...
architecture arch of sha256_data is
    component sha256_data_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    sha256_data_ram_U :  component sha256_data_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
