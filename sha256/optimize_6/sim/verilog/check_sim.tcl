...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sha256.autotvin_istateREG_V.dat"
         "c.sha256.autotvin_idata_V.dat"
         "c.sha256.autotvin_ohash_V.dat"
         "c.sha256.autotvout_ohash_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sha256.autotvout_ohash_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
