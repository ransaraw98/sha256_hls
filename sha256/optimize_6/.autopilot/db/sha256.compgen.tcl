...
set id 1
set name sha256_mux_646_32_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_istateREG_V \
    op interface \
    ports { istateREG_V_dout { I 32 vector } istateREG_V_empty_n { I 1 bit } istateREG_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_idata_V \
    op interface \
    ports { idata_V_dout { I 8 vector } idata_V_empty_n { I 1 bit } idata_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ohash_V \
    op interface \
    ports { ohash_V_din { O 8 vector } ohash_V_full_n { I 1 bit } ohash_V_write { O 1 bit } } \
} "
}
