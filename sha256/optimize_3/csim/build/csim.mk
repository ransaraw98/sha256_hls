...
HLS_SOURCES = ../../../../shatest.cpp ../../../../sha256.cpp
...
$(ObjDir)/shatest.o: ../../../../shatest.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../shatest.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/shatest.d
