...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("stateREG_i", 32, hls_in, 0, "ap_ovld", "in_data", 1),
	Port_Property("stateREG_o", 32, hls_out, 0, "ap_ovld", "out_data", 1),
	Port_Property("stateREG_o_ap_vld", 1, hls_out, 0, "ap_ovld", "out_vld", 1),
	Port_Property("data", 8, hls_in, 1, "ap_none", "in_data", 1),
