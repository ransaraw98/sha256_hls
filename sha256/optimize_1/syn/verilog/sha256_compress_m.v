...
// ==============================================================
`timescale 1 ns / 1 ps
module sha256_compress_m_ram (addr0, ce0, d0, we0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4,  clk);
...
sha256_compress_m_ram sha256_compress_m_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
